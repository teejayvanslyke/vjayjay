...
Vjayjay.plugin('pulsatingSmiley', function(vj, options) {
  ...
  var smiley = vj.raphael.path(smileyPath).attr({fill: "#000", stroke: "#00", "fill-opacity": 1.0, "stroke-width": 1, "stroke-linecap": "round", translation: "360 240"});
  smiley.scale(5);
  ...
  vj.listen(options.changeColorOn, function(event)  {
    smiley.attr({ fill: vj.palette[Utility.random(vj.palette.length - 1)] });
  });
});
